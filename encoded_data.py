...
def extract_custom_data(data):
    """Return a tuple containing the values from our custom hardware."""
    # name(position,size)
    ...
    print(extracted_data[0], extracted_data[1] / 10, extracted_data[2] / 10, extracted_data[3] / 10, extracted_data[4], extracted_data[5]/10, extracted_data[6], extracted_data[7], extracted_data[8], extracted_data[9])
